...
module_eval <<'..end grammar.ra modeval..idb5364c26a7', 'grammar.ra', 745
...
..end grammar.ra modeval..idb5364c26a7
...
module_eval <<'.,.,', 'grammar.ra', 159
  def _reduce_36( val, _values, result )
    ...
    result = ast(AST::ResourceDefaults, :type => val[0], :params => val[2], :doc => @lexer.getcomment)
   result
  end
.,.,
...
module_eval <<'.,.,', 'grammar.ra', 164
  def _reduce_37( val, _values, result )
    result = ast AST::ResourceOverride, :object => val[0], :params => val[2], :doc => @lexer.getcomment
   result
  end
.,.,
...
module_eval <<'.,.,', 'grammar.ra', 309
  def _reduce_69( val, _values, result )
    ...
    result = ast AST::VarDef, :name => variable, :value => val[2], :doc => @lexer.getcomment
   result
  end
.,.,
...
module_eval <<'.,.,', 'grammar.ra', 314
  def _reduce_70( val, _values, result )
    variable = ast AST::Name, :value => val[0]
    result = ast AST::VarDef, :name => variable, :value => val[2], :append => true, :doc => @lexer.getcomment
   result
  end
.,.,
...
module_eval <<'.,.,', 'grammar.ra', 447
  def _reduce_110( val, _values, result )
    result = ast AST::Else, :statements => ast(AST::Nop), :doc => @lexer.getcomment
   result
  end
.,.,
...
module_eval <<'.,.,', 'grammar.ra', 520
  def _reduce_129( val, _values, result )
    ...
    result = ast AST::CaseStatement, :test => val[1], :options => options, :doc => @lexer.getcomment
   result
  end
.,.,
...
module_eval <<'.,.,', 'grammar.ra', 553
  def _reduce_136( val, _values, result )
    result = ast AST::Selector, :param => val[0], :values => val[2], :doc => @lexer.getcomment
   result
  end
.,.,
...
module_eval <<'.,.,', 'grammar.ra', 605
  def _reduce_153( val, _values, result )
    newdefine classname(val[1]), :arguments => val[2], :code => val[4], :doc => @lexer.getcomment
...
module_eval <<'.,.,', 'grammar.ra', 609
  def _reduce_154( val, _values, result )
    newdefine classname(val[1]), :arguments => val[2], :doc => @lexer.getcomment
    @lexer.indefine = false
    result = nil
   result
  end
...
module_eval <<'.,.,', 'grammar.ra', 617
  def _reduce_155( val, _values, result )
    ...
    @lexer.namepop
    newclass classname(val[1]), :code => val[4], :parent => val[2], :doc => @lexer.getcomment
    result = nil
   result
  end
.,.,
...
module_eval <<'.,.,', 'grammar.ra', 627
  def _reduce_157( val, _values, result )
    newnode val[1], :parent => val[2], :code => val[4], :doc => @lexer.getcomment
    result = nil
   result
  end
.,.,
