...
describe Puppet::Storeconfigs::Rails, "when initializing a mysql connection" do
    confine "Cannot test without ActiveRecord" => Puppet.features.rails?
...
describe Puppet::Storeconfigs::Rails, "when initializing a postgresql connection" do
    confine "Cannot test without ActiveRecord" => Puppet.features.rails?
...
describe Puppet::Storeconfigs::Rails, "when initializing an Oracle connection" do
    confine "Cannot test without ActiveRecord" => Puppet.features.rails?
